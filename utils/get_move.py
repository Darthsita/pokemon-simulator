def get_move(move):
    move_list = {
        ...
        "mudslap": {
            ...
            "shortDesc": "100% chance to lower the  accuracy by 1.",
            "id": "mudslap",
            "name": "Mud-Slap",
            "pp": 10,
            "priority": 0,
        ...
        "mudsport": {
            ...
            "basePower": 0,
            "category": "Status",
            "desc": "Forurns, all Electric-type attacks used by any active Pokemon have their power multiplied by 0.33. Fails if this effect is already active.",
        ...
        "roaroftime": {
            ...
            "category": "Special",
            "desc": "If this move is successful, the user must recharge on the following turn and cannot select a move.",
            "shortDesc": "User cannot move next ",
            "id": "roaroftime",
            "name": "Roar of Time",
            "pp": 5,
            "priority": 0,
        ...
        "safeguard": {
            ...
            "basePower": 0,
            "category": "Status",
            "desc": "For 5 turns, the uses party members cannot have major status conditions or confusion inflicted on them by other Pokemon. It is removed from the user's side if the user or an ally is successfully hit by Defog. Fails if the effect is already active on the user's side.",
        ...
        "screech": {
            ...
            "shortDesc": "Lowearget's Defense by 2.",
            "id": "screech",
            "name": "Screech",
            "pp": 40,
            "priority": 0,
        ...
        "stunspore": {
            ...
            "pp": 30,
            "priority": 0,
            "flags": {"powder": 1, "protectlectable": 1, "mirror": 1},
            "status": 'par',
            "secondary": None,
            "target": "normal",
            "type": "Grass",
        ...
        "switcheroo": {
            ...
            "shortDesc": "Uses its held item with the target's.",
            "id": "switcheroo",
            "isViable": True,
            "name": "Switcheroo",
            "pp": 10,
        ...
        "yawn": {
            ...
            "basePower": 0,
            "category": "Status",
            "desc": "Causeget to fall asleep at the end of the next turn. Fails when used if the target cannot fall asleep or if it already has a major status condition. At the end of the next turn, if the target is still active, does not have a major status condition, and can fall asleep, it falls asleep. If the target becomes affected, this effect cannot be prevented by Safeguard or a substitute, or by falling asleep and waking up during the effect.",
    ...
    if move in move_list:
        move_detail = []
        move_detail.append(move_list[move]['name'])
        move_detail.append(move_list[move]['basePower'])
        move_detail.append(move_list[move]['type'].lower())
        move_detail.append(move_list[move]['category'].lower())
        return move_detail
    else:
        return 0